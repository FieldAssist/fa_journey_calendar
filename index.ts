...
export interface JourneyCalendarDto {
  year: number;
  startDate: string;
  endDate: string;
...
export class JourneyCalendar {
  ...
  public readonly journeyCalendar: JourneyCalendarDto[];

  public readonly currentJourneyCalendar: JourneyCalendarDto | undefined;
  public readonly currentJourneyCalendarIndex: number | undefined;

  public readonly lastJourneyCalendar: JourneyCalendarDto | undefined;
  ...
  private _sanitizeJourneyCalendarData(data: JourneyCalendarDto[]) {
  ...
  constructor(data: JourneyCalendarDto[], date?: string | Date) {
    if (date) {
  ...
  public getJourneyCalendar(): JourneyCalendarDto[] {
